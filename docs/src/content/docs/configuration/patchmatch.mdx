  ...
  1. Ensure you have the necessary dependencies installed for your system (see below).
      ...
      <Tabs syncKey="operatingSystem">
        <TabItem label="Windows" icon="seti:windows">
          You're in luck! On Windows x64 PyPatchMatch will install automatically with no extra intervention. There is no prebuilt library for Windows on ARM64, where the `patchmatch` infill method is unavailable.
        </TabItem>
