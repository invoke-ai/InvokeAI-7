"""Starter entries for externally hosted models, plus the provider panel schemas they use.

`BaseModelType.External` is a hosting mode rather than an architecture, so these have no
architecture module of their own."""
