"""Starter models shared across architectures: encoders, image encoders and the VAEs
that more than one architecture installs.

This module must not import any architecture module -- everything here is depended *on*."""
