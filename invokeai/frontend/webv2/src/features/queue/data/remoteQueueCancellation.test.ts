...
import { cancelWithRemoteWorkers } from './remoteQueueCancellation';
...
describe('cancelWithRemoteWorkers', () => {
  ...
  it('sends a native queue item ID to the owner-scoped endpoint before native cancellation', async () => {
    const calls: string[] = [];
