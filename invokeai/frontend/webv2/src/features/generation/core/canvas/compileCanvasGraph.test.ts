import type { BackendGraphContract, GenerationProjectSettings } from '@features/generation/core/contracts';
import type {
...
const PROJECT_SETTINGS: GenerationProjectSettings = { useCpuNoise: true };
