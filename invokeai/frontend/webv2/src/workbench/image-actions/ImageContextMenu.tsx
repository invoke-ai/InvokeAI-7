...
export const ImageContextMenu = ({
  ...
  // The pending deletion and its confirmation dialog must live here, NOT in
  // the menu content: clicking a menu item closes the menu, which nulls
  // `target` and unmounts the content component. State held there would be
  // destroyed before the dialog ever rendered, silently dropping the
  // deletion.
