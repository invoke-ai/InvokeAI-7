  ...
  return (
    <SettingsSection description="Safety checks, prompt editing, and user-assistance behavior." title="Behavior">
      <SettingToggle
        ...
        description="Switch the Invoke source and destination to match the surface you are editing or bring to the front. Locked sources and destinations are never changed."
