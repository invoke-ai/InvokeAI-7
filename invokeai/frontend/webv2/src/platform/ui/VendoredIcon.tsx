...
interface VendoredIconSource {
  ...
  title: string;
  /** The `path` `d` attributes, drawn in order. */
  paths: readonly string[];
  /** The source's viewBox; Simple Icons draw on 24×24. */
  viewBox?: string;
  /** Where the icon came from, when it is not Simple Icons. */
  origin?: string;
}
...
const createVendoredIcon = ({ paths, title, viewBox = '0 0 24 24' }: VendoredIconSource) => {
  ...
  VendoredIcon.displayName = `VendoredIcon(${title})`;

  return VendoredIcon;
};

export const HuggingFaceIcon = createVendoredIcon({
  paths: [
...
export const AlibabaCloudIcon = createVendoredIcon({
  paths: [
...
export const ByteDanceIcon = createVendoredIcon({
  paths: [
...
export const GoogleGeminiIcon = createVendoredIcon({
  paths: [
...
export const GithubIcon = createVendoredIcon({
  paths: [
...
export const DiscordIcon = createVendoredIcon({
...
export const GradientIcon = createVendoredIcon({
  origin: 'Carbon (Apache-2.0)',
  paths: [
    'M26 4H6a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2m-4 22v-4h-4v4h-4v-4h-4v-4h4v-4h-4v-4h4V6h4v4h4V6h4v20Z',
    'M14 10h4v4h-4zm0 8h4v4h-4zm4-4h4v4h-4z',
  ],
  slug: 'gradient',
  title: 'Gradient',
  viewBox: '0 0 32 32',
