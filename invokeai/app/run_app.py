...
def run_app() -> None:
    ...
    # Every registered architecture must declare every required facet. Unlike the invocation-output
    # check above, this raises rather than warns: that one inspects third-party node packs, while
